      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="absolute -top-6 -left-6 w-32 h-32 bg-[#40E0D0]/10 rounded-full blur-3xl" />
            ...
            <div className="absolute -bottom-8 -right-8 bg-[#001F3F] p-8 rounded-3xl shadow-2xl hidden md:block">
              <ShieldCheck className="text-[#40E0D0] w-12 h-12 mb-4" />
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-[#40E0D0] font-bold uppercase tracking-widest text-sm mb-4">Sobre a Anberc</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <CheckCircle2 className="text-[#40E0D0] w-5 h-5 shrink-0" />
            ...
            <div className="pt-4">
              <p className="text-[#778899] italic border-l-4 border-[#40E0D0] pl-6 py-2">
